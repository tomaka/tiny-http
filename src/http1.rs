...
/// A Http1Client is an object that will store a socket to a client
...
impl Http1Client {
    /// Creates a new Http1Client that takes ownership of the TcpStream.
